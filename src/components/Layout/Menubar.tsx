...
const Menubar: React.FC<MenuProps> = (props) => {
  return (
    <div className={`fixed z-30 top-0 left-0 h-screen w-full md:w-60 border-r border-gray-200 flex flex-col justify-start bg-white px-12 sm:px-24 pb-20 md:pb-2 md:px-0 ${props.showMenu ? '' : 'hidden'} md:flex`}>
